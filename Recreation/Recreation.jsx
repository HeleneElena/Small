  ...
  return (
    ...
    <div className={style.wrapper}>
      <svg width="38" height="68" viewBox="0 0 38 68" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M29.5556 34.64C29.5556 51.6455 32.1538 51.1903 36.7009 67.7405C12.3419 70.4348 0 51.6455 0 34.64C0 17.6346 8.44444 0 38 0C35.4017 5.77334 29.5556 17.6346 29.5556 34.64Z" fill="#EEC3FD"/>
      </svg>
          ...
          <tr>
              ...
              <td className={style.tableWrapper}>
                <div className={style.data}>
                  ...
                  <input className={style.inputTime}
                          type="time"
                          value="08:00"
                          min="08:00" max="00:00" 
                          required />
