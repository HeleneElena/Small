            ...
            {/* SPIELE */}
            {
                ...
                <div>
                    ...
                    <table>
                        ...
                        <tbody>
                            {
                                props.produkte[props.formular.hauptkategorie].gruppe[props.formular.unterkategorie].artikel.map((ele) => {
                                    return (<tr>
                                        <td>{ele.titel}</td>
                                        <td>{ele.preis} EUR</td>
                                        <td onClick={() => {props.hinzufuegenZumWarenkorb(ele)}}>Hinzufügen</td>
                                    </tr>)
                                })
                            }
                        </tbody>
